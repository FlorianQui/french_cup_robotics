...
(cl:defmethod cl:initialize-instance :after ((m <MyMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name move-msg:<MyMsg> is deprecated: use move-msg:MyMsg instead.")))
...
(cl:defmethod theta-val ((m <MyMsg>))
